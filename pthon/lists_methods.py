...
11:22:23 From ASIF ALI (A.I) To Everyone : ASIF ALI
PIAIC 183730
...
11:24:50 From Junaid Ali Bhatti To Everyone : Junaid Ali Bhatti 
PIAIC174125
...
11:41:19 From MUHAMMAD USMAN MANZOOR To Everyone : PIAIC128778
...
for r in data3.split("\n"): #split row wise
    ...
    #     # print(d[0].split(":")[-1])
    #     print(d)
    a= re.findall('PIAIC\d{1,7}',r) #print PIAIC and roll number
    b= re.findall('AIC\d{1,7}',r) #print AIC and roll number
    result= a+b
